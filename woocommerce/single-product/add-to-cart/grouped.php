...
include dirname( __FILE__ ) . '/op_woo_header.php';?>
    <form class="cart cst-simple-form grouped_form" action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" enctype='multipart/form-data'>
        ...
        <?php if ( $quantites_required ) : ?>
            ...
            <button type="submit" class="single_add_to_cart_button button alt productX_addtocard"><?php echo esc_html( $product->single_add_to_cart_text() ); ?><span id="productx_price" product_price="<?php echo sprintf("%.2f", $product->get_price()); ?>"><?php echo sprintf("%.2f", $product->get_price()); ?></span></button>
        <?php endif; ?>
