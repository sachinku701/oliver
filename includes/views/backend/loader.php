<div class="loader-fixed" id="image_loading" style="display: none">
    <div class="loader-centered">
        <svg version="1.1" id="ologo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 400 400" style="enable-background:new 0 0 400 400;" xml:space="preserve" width="100" height="100">
                        <style type="text/css">
                            .st0{fill:#A1E663;}
                            .st1{fill:#47D2A5;}
                            .st2{fill:#1DB9CA;}
